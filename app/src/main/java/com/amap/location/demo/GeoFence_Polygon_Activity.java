...
public class GeoFence_Polygon_Activity extends CheckPermissionsActivity
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bitmap = BitmapDescriptorFactory
				.defaultMarker(R.drawable.ic_launcher);
		markerOption = new MarkerOptions().icon(bitmap).draggable(false);
		init();
	}
...
//	}
	...
	public void onLocationChanged(AMapLocation amapLocation) {
		...
		Log.e("onLocationChanged", "mListener is null? "+(mListener == null));
		Log.e("onLocationChanged", "amapLocation is null? "+(amapLocation == null));
	...
	private void addPolygonMarker(LatLng latlng) {
		markerOption.position(latlng).title("1111111111111").snippet("sddddddd");
